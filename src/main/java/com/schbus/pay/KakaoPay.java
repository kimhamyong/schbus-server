...
public class KakaoPay {
    ...
    public KakaoPayReadyVO kakaoPayReady() {
        ...
        params.add("approval_url", "http://10.114.10.15:8080/kakaoPaySuccess");
        params.add("cancel_url", "http://10.114.10.15:8080/kakaoPayCancel");
        params.add("fail_url", "http://10.114.10.15:8080/kakaoPaySuccessFail");
